...
public class Embedding {
	...
	public static final String SET1_LETTER = "v";
	public static final String SET2_LETTER = "u";
	
	protected int     id;
	protected int     sourceEmbeddingId;
	protected int     referenceEmbeddingId;
	protected boolean insertionPossible;
	...
	// save the gaps; the crossing is mapped to one of the outgoing edges that has a gap
	...
	/**
	 * Creates a copy of the given embedding.
	...
	/**
	 * Creates a reversed copy of the given embedding.
	...
	/**
	 * Creates a new vertex with an auto-generated id.
	 * @return the vertex
	 */
	...
	/**
	 * Creates a new edge with the given id, source and target.
	...
	/**
	 * Creates a new edge with an auto-generated id.
	 * @return	this edge
	 */
	...
	/**
	 * Creates a new face with the given id and incident edge
	 * @param id			the id of this edge
	...
	/**
	 * Creates a new face with the given id.
	...
	/**
	 * Creates a new face with an auto-generated id.
	 * @return	this face
	 */
	...
	/**
	 * Returns all incident edges to the given face.
	 * @param face	the face
	...
	/**
	 * Returns the incident out edges to a given vertex.
	 ...
	 * Added are all edge parts including the twin edges.
	 * @param int 	the vertex id
	 * @return		list of all incident edges
	 */
	...
	/**
	 * Inserts an edge between source and target in the given face.
	 * It is assumed that source, target and face are already present
	 * in the drawing. It is taken care of all the pointers and the
	 * twin edge.
	...
	/**
	 * Returns for the edge with id <code>edgeId</code> the real
	 * source (the source vertex that is not a crossing).
	 * @param edgeId
	 * @return
	 */
	...
	/**
	 * Returns for the edge with id <code>edgeId</code> the real
	 * target (the target vertex that is not a crossing).
	 * @param edgeId
	 * @return
	 */
	...
	/**
	 * Returns an edge part of the edge to which this gap is belonging.
	 * @param gap
	 * @return
	 */
	...
	/**
	 * Maps a gap crossing to an edge part.
	 * @param crossing
	 * @param edge
	 */
	...
	/**
	 * True, if and only if the edgepart is part of an edge with a gap.
	 * @param edge
	 * @return
	 */
