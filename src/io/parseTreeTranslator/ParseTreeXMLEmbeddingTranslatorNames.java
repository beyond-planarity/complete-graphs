 ...
 *
 */
public class ParseTreeXMLEmbeddingTranslatorNames {

	private static final String L_EMBEDDING      = "embedding";
	private static final String L_VERTEX_SET     = "vertexSet";
	private static final String L_EDGE_SET       = "edgeSet";
	private static final String L_FACE_SET       = "faceSet";
	private static final String L_ID             = "id";
	private static final String L_SOURCE_ID      = "sourceId";
	private static final String L_REFERENCE_ID   = "referenceId";
	private static final String L_VERTEX         = "vertex";
	private static final String L_NAME           = "name";
	private static final String L_IS_CROSSING    = "isCrossing";
	private static final String L_TRUE           = "1";
	private static final String L_FALSE          = "0";
	private static final String L_OUT_EDGE       = "outEdge";
	private static final String L_NO_SUCH_ELEMENT= "-1";
	private static final String L_EDGE           = "edge";
	private static final String L_EDGE_AFTER_CR  = "edgeAfterCr";
	private static final String L_EDGE_BEFORE_CR = "edgeBeforeCr";
	private static final String L_SOURCE         = "source";
	private static final String L_TARGET         = "target";
	private static final String L_LEFT_FACE      = "leftFace";
	private static final String L_TWIN           = "twin";
	private static final String L_NEXT           = "next";
	private static final String L_PREVIOUS       = "previous";
	private static final String L_FACE           = "face";
	private static final String L_INCIDENT_EDGE  = "incidentEdge";

	private static final String L_X              = "x";
	private static final String L_Y              = "y";
	private static final String L_STRECHED_X     = "strechedX";
	private static final String L_STRECHED_Y     = "strechedY";
	private static final String L_LABEL          = "label";
	private static final String L_COLOR          = "color";
	
	private static final String L_NEXT_EMBEDDING      = "nextEmbedding";
	private static final String L_PREV_EMBEDDING      = "prevEmbedding";
	private static final String L_NEXT_TOPO_EMBEDDING = "nextTopoEmbedding";
	private static final String L_PREV_TOPO_EMBEDDING = "prevTopoEmbedding";
	private static final String L_INSERTION_POSSIBLE  = "insertionPossible";
	private static final String L_DRAWING_NO          = "drawingNo";
	private static final String L_TO_DRAW             = "toDraw";
